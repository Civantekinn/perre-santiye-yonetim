import { bugunISO, paraFormat, requireOturum } from "@/lib/auth";
...
export default async function SantiyeDetayPage({
  ...
  const { profil, santiyeIds, user } = await requireOturum();
  const supabase = createClient();

  if (!santiyeIds.includes(santiye_id) && profil.rol !== "admin") {
    redirect("/santiye/santiyeler");
  }
